namespace App.Services.StateMachines
{
    ...
    abstract class BaseRoleStateMachine
    {
        private IRoleService service;

        public BaseRoleStateMachine(IRoleService service)
        {
        ...
        /// <returns></returns>
        protected bool TryUpdateItemState(int id, RoleTriggers trigger, List<IModelError> errors, IModelContext context = null)
        {
