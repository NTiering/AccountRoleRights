...
namespace App.Tests.Services.Validation
{
    ...
    {        
        [TestMethod]
        public void Can_Resolve_RoleService()
        {
            var service = registerClient.Get<IRoleService>();
            Assert.IsNotNull(service);
        }

        [TestMethod]
        public void Valid_RoleDataModels_cause_no_errors()
        {
            var service = registerClient.Get<IRoleService>();
        ...
        [TestMethod]
        public void Valid_RoleDataModels_can_be_saved()
        {
            var service = registerClient.Get<IRoleService>();
            var model = GetValidDataModel(true);
            var errors = new List<IModelError>();
        ...
        [TestMethod]
        public void Get_returns_correct_RoleDataModel()
        {
            var model = GetValidDataModel(true);
            roleDal.Setup(x => x.Get(33, It.IsAny<IModelContext>())).Returns(model);

            var errors = new List<IModelError>();
            var result = registerClient.Get<IRoleService>().Get(33, errors);
        ...
        public void Get_no_DeliveryDataModels()
        {
            ...
            var errors = new List<IModelError>();
            var result = registerClient.Get<IRoleService>().Get(44, errors);
        ...
        private static IRoleDataModel GetValidDataModel(bool isNew)
        {
            var rtn = new Mock<IRoleDataModel>();
